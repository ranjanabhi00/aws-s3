...
const bucket_entity_1 = require("../bucket/bucket.entity");
...
], FileObject.prototype, "url", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => bucket_entity_1.Bucket, (bucket) => bucket.fileObjects),
    __metadata("design:type", bucket_entity_1.Bucket)
], FileObject.prototype, "bucket", void 0);
exports.FileObject = FileObject = __decorate([
    (0, typeorm_1.Entity)('file_object')
], FileObject);
